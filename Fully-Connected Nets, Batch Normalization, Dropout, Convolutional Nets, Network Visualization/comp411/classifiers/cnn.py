...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        param1, c1 = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)
        param2, c2 = affine_relu_forward(param1, W2, b2)
        param3, c3 =affine_forward(param2, W3, b3)
        scores= param3
        ...
        dx, dw, db = affine_backward(grad, c3)
